...
export default function Admin() {
  ...
  // Structure:
  // Firestore field (lastName) : JavaScript variable (lastname)
  const addData = () => {
  ...
  const getID = (id, lastName, firstName, sex, birthdate, address) => {
    setID(id)
  ...
  const getIDtoView = (id, lastName, firstName, sex, birthdate, address) => {
    setID(id)
    setLastName(lastName)
    setFirstName(firstName)
    setSex(sex)
  ...
  const updateField = (id) => {
    console.log(id) // For tracking purposes

    let fieldToEdit = doc(database, 'Person', ID);
  ...
  const buttonClickPrintOnly = (ID, lastName, firstName, sex, birthdate, address) => {
    getID(ID, lastName, firstName, sex, birthdate, address);
    console.log("Inside buttonClickPrintOnly: " + birthdate);
    getBirthYear();
    window.print();
    return false; 
  }
  ...
  <div className="px-6 h-full text-gray-800">
    ...
    >
      ...
      <div className="xl:ml-20 xl:w-5/12 lg:w-5/12 md:w-8/12 mb-12 md:mb-0">
        <form>
          ...
          >
            <p className="print:hidden text-center font-semibold mx-4 mb-0">HELPS Registration v1.00 Admin</p>
          </div>
    ...
    {/** This is the admin table to view records*/}
    <div class="print:hidden mb-0 flex flex-col xl:ml-5 xl:mr-5 xl:w-8/8 lg:w-8/8 md:w-12/12 sm:mb-0">
                <div class="sm:-mx-6 lg:-mx-8 sm:mb-0">
                    <div class="py-2 inline-block min-w-full sm:px-6 lg:px-8 sm:mb-0">
                    <div>
                        ...
                        <thead class="border-b">
                            ...
                            <th scope="col" class="text-sm font-medium text-gray-900 px-6 py-4 text-left">Operations</th>
                            </tr>
                        </thead>
                        <tbody>
                            ...
                            {fireData.map((data) => {
                                        return (
                                                ...
                                                <tr class="border-b">
                                                    ...
                                                    <td class="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap">{data.lastName}</td>
                                                    <td class="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap">{data.firstName}</td>
                                                    <td class="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap">{data.sex}</td>
                                                    <td class="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap">{data.birthdate}</td>
                                                    ...
                                                    {isUpdate ? (
                                                      ...
                                                      onClick={() => getID(data.id, data.lastName, data.firstName, data.sex, data.birthdate, data.address)} 
                                                      >Update</button>
                                                    ): (
                                                      <button
                                                      type="button"
                                                      ...
                                                      onClick={updateField}
                                                      >Save to update database</button>
                                                    )}
                                                    ...
                                                    <button
                                                        class="shadow bg-purple-500 hover:bg-purple-400 focus:shadow-outline focus:outline-none text-white font-bold py-2 px-4 rounded" type="button"
                                                        onClick={() => getIDtoView(data.id, data.lastName, data.firstName, data.sex, data.birthdate, data.address)}
                                                    >View to Print</button></td>
                                                </tr>
                                        )
                                    })}
                        </tbody>
